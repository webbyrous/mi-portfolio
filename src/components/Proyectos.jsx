                ...
                <div ref={carruselRef} className='flex overflow-x-auto snap-x snap-mandatory scrollbar-none min-w-0 gap-6 px-10 lg:justify-center'>
                    {proyectosData.map((proyecto) => (
                        ...
                        <div className='w-full h-48 sm:h-52 overflow-hidden'>
                            <img src={proyecto.image} alt={`Captura del proyecto ${proyecto.title}`} className='w-full h-full object-cover object-top transition-transform duration-300 hover:scale-105 '/>
                        </div>
                        ...
                        <div className='px-3 py-3 flex flex-col flex-1'>
                            ...
                            {proyecto.tags.map((tag, index) => (
                                <span key={index} className='bg-tag-soft/80 px-2 py-0.5 text-xs rounded-md'>{tag}</span>
                            ))}
                            </div>
                            {/* Enlaces inferiores */}
