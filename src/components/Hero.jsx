        ...
        <div className='bg-peach'>
            <div className='grid grid-cols-1 md:grid-cols-2 px-6 py-12 font-family max-w-6xl mx-auto items-center gap-10'>
                <div className='flex flex-col gap-4 order-2 md:order-1 text-center md:text-left'>
                    <h1 className=' md:pt-7 text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-medium text-slate-800 leading-tight md:max-w-md'>Hola, soy <span className='text-pink font-semibold'>Rosario</span>, Desarrolladora Web Junior</h1>
                    ...
                    <a
                        ...
                        className="px-6 py-3 bg-pink text-white font-bold rounded-xl shadow-md hover:bg-pink/60 transition-colors flex items-center justify-center gap-2 max-w-max mx-auto md:mx-0"
                    >
