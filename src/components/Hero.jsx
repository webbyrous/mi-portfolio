...
export default function Hero() {
    return (
        <div className='bg-peach dark:bg-dark-bg-strong transition-colors duration-300 scroll-mt-20' id="inicio">
            <div className='grid grid-cols-1 lg:grid-cols-2 px-6 py-12 font-family max-w-6xl mx-auto items-center gap-10'>
                ...
                sm:max-w-[340px] sm:h-[420px] md:max-w-[400px] md:h-[480px] mx-auto flex items-center justify-center p-4 order-1 lg:order-2'>
